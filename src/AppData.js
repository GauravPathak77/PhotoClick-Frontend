...
const AppData = () => {
  ...
  const sendArrayToBackend = async (urls) => {
    try {
      ...
      const response = await axios.post('https://photoclickbackend-production.up.railway.app/api/data', { array: urls });
  ...
  const fetchData = async () => {
    try {
      // Change url with url of server
      const response = await axios.get('https://photoclickbackend-production.up.railway.app/api/data'); 
